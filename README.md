...
<a id="update20220513">**2022年5月13日 更新** </a>  
**摘要：** 新增参考文献、附录、致谢前的打印分页  
**使用方法：**  
修改`sdnubachelor.tex`第15行数值为1；  
...
4. 自定义打印：支持自定义打印版/电子版，打印版会在部分页面后加空页（目录、摘要通过判断奇偶确定是否加空页）（更新参考[2022年5月13日更新说明](#update202205013)）；
